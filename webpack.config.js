 ...
 */
// generated on 2017-11-29 using generator-openmrs-owa 0.6.0
'use strict';
...
const THIS_APP_ID = 'moduloinventariohlb';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/moduloinventariohlb`,
	  css: `${__dirname}/app/css/moduloinventariohlb.css`,
	  vendor : [
