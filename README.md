...
This repository contains the moduloInventarioHLB OpenMRS Open Web App.
...
This will create a file called `moduloinventariohlb.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/usr/share/tomcat7/.OpenMRS/owa`
...
{
  "LOCAL_OWA_FOLDER": "/usr/share/tomcat7/.OpenMRS/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/moduloinventariohlb/index.html"
}
```
